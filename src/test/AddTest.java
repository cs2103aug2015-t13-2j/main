...
/*
 * Unit test file for adding functions
 */

//@@author - A0124710W
public class AddTest {
	Logic logic = new Logic();
	String invalidAdd = "Invalid description of task and date.";
	...
	String res7 = logic.executeUserCommand("add");
	String res8 = logic.executeUserCommand("addevent1");
	...
	public void addTest() {
		...
		assertEquals(invalidAdd, res7);
		assertEquals(invalidCommand, res8);
	}
