...
public class EditTest {
	...
	String addRes5 = logic.executeUserCommand("add REMEMBER TO WATER PLANTS start \"5 october 2015 7am\" end \"5 october 2015 7.10am\"");
	...
	// Test for editing names
		...
		public void testEditName() {
			...
			/* To test whether task is added into array
			assertEquals(expectedAdd, addRes1);
			assertEquals(expectedAdd, addRes2);
			 */	
		...
		public void testEventEditDate() {
			...
			/* To test whether task is added into array
			assertEquals(expectedAdd, addRes3);
			assertEquals(expectedAdd, addRes4);
		...
		public void testDeadlineEditDate() {
			...
			/* To test whether task is added into array
			assertEquals(expectedAdd, addRes6);
			assertEquals(expectedAdd, addRes7);
		...
		public void testTodoEditDate() {
			...
			expectedTask10.setTaskType("deadline");
		 	...
		 	/*To test whether task is added into array
			assertEquals(expectedAdd, addRes9);
			assertEquals(expectedAdd, addRes10);
			*/
